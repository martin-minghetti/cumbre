...
const PRODUCTS = [
  ...
  {
    slug: 'laguna-negra-schwarzbier-porron',
    name: 'Laguna Negra',
    style: 'Schwarzbier',
    format: 'porron_1l' as const,
    abvDefault: 50,
    ibuDefault: 26,
    description: 'Lager negra alemana. Maltas Pilsen, Munich y Carafa Special II. Color casi opaco, espuma marrón densa. Cuerpo medio, final limpio con notas sutiles de chocolate y café tostado. Engaña: parece densa, toma fácil.',
    heroImageUrl: '/products/laguna-negra-packshot.jpg',
    reorderPoint: 100,
    packs: [
      { size: 1, priceCents: 580000, sku: 'LAG-SCH-P1L-1' },
      { size: 6, priceCents: 3100000, sku: 'LAG-SCH-P1L-6' },
    ],
    initialBatch: {
      lotCode: 'SCH-260428-01',
      abv: 50, ibu: 26, volume: 600, units: 580, costCents: 42000000,
      notes: 'Saflager W-34/70 a 12°C, lagering 5 semanas. Carafa Special II 3.5% para color sin astringencia. Limpia, sin off-flavors tostados.',
    },
  },
  {
    slug: 'jakob-porter-lata',
    name: 'Jakob',
    ...
    reorderPoint: 120,
    packs: [
      { size: 1, priceCents: 360000, sku: 'JAK-POR-L473-1' },
      { size: 6, priceCents: 1900000, sku: 'JAK-POR-L473-6' },
    ],
    initialBatch: {
